...
$if(extra)$
\subsubsection*{\textsc{Reimbursable Expenses}}
\begin{spreadtab}{{tabular}[t t]{lp{8.2cm}r}}
  @ \noalign{\vskip 1mm} & @ \textbf{Description} & @ \textbf{Amount in $currency$} \\ \hline
      $for(extra)$ @ \noalign{\vskip 1mm} 
        & @ $extra.description$
        $if(extra.details)$\newline \begin{itemize} 
...
\textsc{\scriptsize{Please note: Invoices are issued without disclosure of VAT according to § 19 UStG.}}
